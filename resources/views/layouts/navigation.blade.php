<nav class="border-b border-gray-100 bg-white dark:border-gray-700 dark:bg-gray-800" x-data="{ open: false }">
        ...
        <div class="flex h-16 justify-between">
            <div class="flex">
                ...
                <div class="flex shrink-0 items-center">
                    <a href="{{ route('index') }}">
                        <h1 class="text-lg font-bold italic text-white">ELRUMI <span class="text-orange-500">TOBACCO</span> .</h1>
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('riwayat-pemesanan')" :active="request()->routeIs('riwayat-pemesanan')">
    ...
    <div class="hidden sm:hidden" :class="{ 'block': open, 'hidden': !open }">
        <div class="space-y-1 pb-3 pt-2">
            <x-responsive-nav-link :href="route('riwayat-pemesanan')" :active="request()->routeIs('riwayat-pemesanan')">
                {{ __('Riwayat Pemesanan') }}
